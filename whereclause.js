...
connection.connect((err) => {
  ...
  connection.query(query, [targetSalary], (error, results) => {
    ...
    console.log(`Employee Records with Salary ${targetSalary}:`);
    results.forEach((row) => {
